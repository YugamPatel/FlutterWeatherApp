...
class _HomePageState extends State<HomePage> {
  var city = "Toronto";
  var fdata = TextEditingController(text: "Toronto");
  var temp = "";
  final apiK = "a1321a705a5d2ebee71f51cd279649e1";
  var data;
  var name;
  var icon;
  var description;
  ...
  Future<void> fetchData({required var city}) async {
    ...
    image =
        "https://source.unsplash.com/random/${height.toString()}x${width.toString()}/?${city.toString()}";
    ...
    return Scaffold(
      body: Center(
        child: Stack(fit: StackFit.expand, children: [
          Image.network(
            image ??
                "https://source.unsplash.com/random/${width.toString()}x${height.toString()}/?${city.toString()}",
            fit: BoxFit.cover,
          ),
          Center(
            child: ClipRRect(
